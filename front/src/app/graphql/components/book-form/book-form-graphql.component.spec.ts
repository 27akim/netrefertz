...
import { of } from 'rxjs';
import { BookFormComponentGraphQL } from './book-form-graphql.component';
...
describe('BookFormComponentGraphQL', () => {
  let component: BookFormComponentGraphQL;
  let fixture: ComponentFixture<BookFormComponentGraphQL>;
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      ...
      declarations: [BookFormComponentGraphQL],
      providers: [
    ...
    fixture = TestBed.createComponent(BookFormComponentGraphQL);
